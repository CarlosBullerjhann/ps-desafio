...
class SiteController extends Controller
{
    ...
    public function comprar(Request $request, $id)
    {
        ...
        if (($produto->quantidade >= $quantidade) && ($quantidade > 0)) {
            ...
            $produto->save();
            return redirect()->back()->with('sucesso', 'Produto comprado com sucesso!');
        } else {
            return redirect()->back()->with('erro', 'quantidade solocitada superior ao estoque ou não possui mais esse item no estoque.');
        }
    }
}
